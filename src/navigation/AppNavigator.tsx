...
const AppNavigator = () => {
  return (
    ...
    >
      ...
      {/* Main App Screens - Aligned with Website Structure */}
      ...
      <Stack.Screen name="AccountSettings" component={AccountSettingsScreen} options={{ title: 'Settings' }} />
      ...
      <Stack.Screen name="Contribution" component={ContributionScreen} options={{ title: 'Make Contribution' }} />
